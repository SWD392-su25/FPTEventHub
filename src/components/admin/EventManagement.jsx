...
import {
  ...
  Paper, IconButton, Dialog, DialogActions, DialogContent, DialogTitle, TextField, MenuItem, InputAdornment
} from "@mui/material";
  ...
  return (
    <div className={styles.adminContainer}>
      ...
      <Dialog open={confirmOpen} onClose={() => setConfirmOpen(false)}>
        ...
        <DialogContent>
          <p>
            Nhập lại tên sự kiện để xác nhận: <strong>{targetEvent?.name}</strong>
          </p>
          <TextField
            autoFocus
            fullWidth
